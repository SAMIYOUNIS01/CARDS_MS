...
@ControllerAdvice
public class HandelGlobalExceptions extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handelGlobalExceptioins(
            Exception exception,
    ...
    public ResponseEntity<ErrorResponseDto> handleCardsAlreadyExistsException(
            CardsAlreadyExistsException exception,
            WebRequest webRequest)
    {
